...
-- PARTITION FUNCTION
-- BOUNDARIES (LIMITES)
-- (CASI SIEMPRE VALORES TIPO FECHA )
...
-- TODOS LOS ANTERIORES			01/01/2016			01/01/2017		    RESTANTES
--		---------------------------|----------------------|----------------



-- PARTITION SCHEME ASIGNAMOS LA FUNCION A UN ESQUEMA 
...
--------------------
INSERT INTO Alta_Coleg 
	VALUES ('Ismael','Cabana','2017-21-05'), 
...
INSERT INTO Alta_Coleg 
	VALUES ('Amanda','Smith','2018-12-02'), 
	('Adolfo','Muñiz','2018-23-01'), 
	('Rosario','Fuertes','2018-23-02')
GO
